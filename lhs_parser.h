...
#define LHS_TOKENSWITCH          (LHS_TOKENRESERVEDBEGIN + 8)              
#define LHS_TOKENCASE            (LHS_TOKENRESERVEDBEGIN + 9)              
#define LHS_TOKENDEFAULT         (LHS_TOKENRESERVEDBEGIN + 10)             
#define LHS_TOKENBREAK           (LHS_TOKENRESERVEDBEGIN + 11)             
#define LHS_TOKENCONTINUE        (LHS_TOKENRESERVEDBEGIN + 12)             
#define LHS_TOKENTRUE            (LHS_TOKENRESERVEDBEGIN + 13)             
#define LHS_TOKENFALSE           (LHS_TOKENRESERVEDBEGIN + 14)             
#define LHS_TOKENRETURN          (LHS_TOKENRESERVEDBEGIN + 15)             
#define LHS_TOKENRESERVEDEND     (LHS_TOKENRESERVEDBEGIN + 16)
#define LHS_TOKENIDENTIFIER      (LHS_TOKENRESERVEDBEGIN + 17)             
#define LHS_TOKENINTEGER         (LHS_TOKENRESERVEDBEGIN + 18)             
#define LHS_TOKENNUMBER          (LHS_TOKENRESERVEDBEGIN + 19)             
#define LHS_TOKENSTRING          (LHS_TOKENRESERVEDBEGIN + 20)             
