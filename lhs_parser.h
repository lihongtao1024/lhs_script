...
#define LHS_TOKENLOGICAND        (LHS_TOKENSYMBOLBEGIN + SYMBOL_LOGICAND)          //&&        275
#define LHS_TOKENLOGICOR         (LHS_TOKENSYMBOLBEGIN + SYMBOL_LOGICOR)           //||        276
#define LHS_TOKENBLSHIFT         (LHS_TOKENSYMBOLBEGIN + SYMBOL_BLSHIFT)           //<<        277
#define LHS_TOKENBRSHIFT         (LHS_TOKENSYMBOLBEGIN + SYMBOL_BRSHIFT)           //>>        278
#define LHS_TOKENSYMBOLEND       (LHS_TOKENBRSHIFT  + 1)                           //  
